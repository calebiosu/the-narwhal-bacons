...
def cross_val_roc_plot(classifier, X, y, label):
    ...
    for i, (train, test) in enumerate(cv):
        ...
        # probas is percentage of trees that returned 1
...
# verbose = detail of returned results
clf = RandomForestClassifier(n_estimators=20, compute_importances=True, verbose=1)
